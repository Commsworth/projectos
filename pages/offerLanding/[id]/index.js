...
const OfferLanding = () => {
    ...
    const data=[
        {Header: "Digital Experience Monitoring from Dynatrace", content1: ["Optimize user experiences by ensuring every application is available, functional, fast and efficient across web, mobile, and IoT channels."] },
        {Header: "Kubernetes Monitoring: Fact Sheet", content1: ["Kubernetes is quickly becoming the default container orchestration engine for the enterprise. Using automation, Kubernetes can manage billions of containers and scale with ease. Shouldn’t your monitoring solution be able to do the same?"] },
        {Header: "A Guide to Cloud Native Microservices", content1: ["In this guide to cloud native microservices, industry thought leader, The New Stack, explores best practice in building, deploying and managing these scaled-out architectures.", "The guide focuses on the human element in all this. The intention is to help readers understand the complexities of shifting DevOps cultures, the people involved and the tools they employ across three key stages:", "1. What people need to know when shifting to microservices 2. Success strategies and practices when deploying microservices 3. Insights into managing microservices in production","Download your copy and get expert insight from Dynatrace DevOps activist Andreas Grabner on breaking up your monolith into microservices."] },
        {Header: "AIOPs Done Right: eBook", content1:["As today’s enterprise systems increase in size, the benefits of digitization and cloud computing go hand in hand with technological complexity and operational risks. Download this eBook to see how AI promises to enable autonomous operations, boost innovation, and offer new modes of customer engagement by automating everything"]},
        {Header: "Five Key Considerations for Enterprise Cloud Monitoring: eBook", content1: ["Software is taking over the world. As a result, every business needs to embrace software as a core competency to ensure survival and prosperity. However, the transformation into a software company is a significant task, as building and running software today is harder than ever. ", "This eBook outlines key considerations as you move through the journey to embrace modern software technologies, platforms and elements to truly set up to deliver your business software faster, and with higher quality, in the enterprise cloud. "]},
        {Header: "Life made simpler with Dynatrace, through the eyes of the customer: Video", content1: ["Software is taking over the world. As a result, every business needs to embrace software as a core competency to ensure survival and prosperity. However, the transformation into a software company is a significant task, as building and running software today is harder than ever."]},
        {Header: "", content1: ["This eBook outlines key considerations as you move through the journey to embrace modern software technologies, platforms and elements to truly set up to deliver your business software faster, and with higher quality, in the enterprise cloud. "]}
    ]
        ...
        <div className="container" style={{background: "white"}}>
            <div className='ct1'>
                ...
                <h1>Assess threat to your business</h1>
                    ...
                    {data[dataID].content1.map(cont=><p>{cont}</p>)}
