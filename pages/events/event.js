...
import { Client, PRISMIC_heading, PRISMIC_link, PRISMIC_link_text, PRISMIC_heading2, PRISMIC_icon, PRISMIC_text } from '../../prismic-configuration';
                        ...
                        <div className="event_flx" >
                            {
                                contactCards.map(item => {
                                    return <div className="contacts-ct">
                                        <img src={PRISMIC_icon(item)} alt="" />
                                        <h1>
                                            {[PRISMIC_heading(item)]}
                                        </h1>
                                        <p>
                                            {PRISMIC_text(item)}
                                        </p>
