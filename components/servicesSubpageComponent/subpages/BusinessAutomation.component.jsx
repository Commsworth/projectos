              ...
              <div style={{width: '100%'}}>
                <div className="box  dark-bg">
                    <div className='tp-wrapper'>
                         ...
                         <Dropdownn active="Business Automation" id='select' />
                   
                <div className="tp">
                    <div className="tp1">
                        <Card title="Business Automation & Productivity" 
                    ...
                    <div className="tp2">
                        <img src="/static/exploreimg/business-automation.svg" alt="" />
                    </div>
                    </div>
                </div>
                </div>
...
export default ProductAndDigital;
